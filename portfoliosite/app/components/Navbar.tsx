        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div>
            <button
              ...
              className="relative border hover:border-green-600 duration-500 group cursor-pointer text-green-50 overflow-hidden h-8 w-42 rounded-md bg-green-800 p-2 flex justify-center items-center font-extrabold transform transition-transform hover:scale-125"
            >
              ...
              <span className="z-10 flex flex-row space-x-1 items-center">
                <span>Contact Me</span> <FaUser className="text-md" />
              </span>
            </button>
          </div>
        </div>
